		...
		<form action="/admin/adminProductWriteForm" method="post" id="enrollForm" enctype="multipart/form-data">
			...
			<table class="table" style="text-align: center; border: 1px solid #dddddd; width: 70%;">
				<tr>
					...
					<td colspan="4">
						<input id="bName_select" placeholder="옆의 버튼을 눌러 브랜드를 선택하세요." readonly="readonly" style="Width: 75%">
						<input id="bName_input" name="bname" type="hidden">
				...
				<tr>
					...
					<td colspan="4">
						<input id="pnameId" name="pname" placeholder="상품명을 입력하세요.">
				...
				<tr>
					...
					<td colspan="4">
						...
						<label>
							<input type="radio" name="pGender" value="2">
							여성용
						</label>
						<label>
							<input type="radio" name="pGender" value="3">
							공용
						</label>
				...
				<tr>
					...
					<td>
						<input name="balance" type="number" placeholder="숫자만 입력하세요.">
						<div>
				...
				<tr>
					...
					<td>
						...
						<div>
							...
							</span> <span class="ck_warn price_warn">등록하실 상품의 가격을 입력해주세요.</span>
						</div>
					</td>
