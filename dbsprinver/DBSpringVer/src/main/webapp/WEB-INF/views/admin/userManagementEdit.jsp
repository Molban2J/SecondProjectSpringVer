...
<body>
	<div id="wrap" align="center">
		<h1>유저 정보 수정</h1>
		<form action="/admin/userEditComplete.do" method="post"
			name="frm"
		>
			<table class="list">
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="userid" value="${shopUser.userid }"
							readonly="readonly"
						>
					</td>
					<th>비밀번호</th>
					<td>
						<input type="text" name="pass" value="${shopUser.pass }"
							required="required"
						>
					</td>
					<th>이름</th>
					<td>
						<input type="text" name="name" value="${shopUser.name }"
							required="required"
						>
					</td>
				</tr>
				...
				<tr>
					...
					<th>이메일</th>
					<td>
						<input type="email" name="email" value="${shopUser.email }">
					</td>
					<th>등급</th>
					<td>
						<select name="grade">
				...
				<tr>
					<th>주소</th>
					<td>
						<input type="text" name="address1" value="${shopUser.address1 }">
					</td>
					<th>상세 주소</th>
					<td>
						<input type="text" name="address2" value="${shopUser.address2 }">
					</td>
					<th>우편번호</th>
					<td>
						<input type="text" name="zipcode" value="${shopUser.zipcode }">
					</td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td>
						<input type="text" name="phone" value="${shopUser.phone }"
							placeholder="01012341234"
						>
					</td>
					<th>포인트</th>
					<td>
						<input type="text" name="point" value="${shopUser.point }">
					</td>
					<th>가입일자</th>
					<td>
						<fmt:formatDate value="${shopUser.enter }" />
					</td>
				</tr>
